...
public class CultureChunk {
	...
	public String getOnLeaveString() {
		return CivColor.LightPurple+"Leaving the town borders of"+" "+town.getCiv().getName();
	}
	
	public String getOnEnterString() {
		return CivColor.LightPurple+"Entering the town borders of"+" "+town.getCiv().getName();
	}
