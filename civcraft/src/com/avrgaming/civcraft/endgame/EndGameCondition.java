	...
	public void onFailure(Civilization civ) {
		...
		for (SessionEntry entry : entries) {
			if (civ == EndGameCondition.getCivFromSessionData(entry.value)) {
				CivMessage.global(CivColor.LightBlue+CivColor.BOLD+civ.getName()+CivColor.White+" "+CivSettings.localize.localizedString("end_warLoss")+" ["+CivColor.LightPurple+CivColor.BOLD+this.victoryName+CivColor.White+"]");
